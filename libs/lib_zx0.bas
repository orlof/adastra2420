DIM _SrcAddr AS WORD @$16
DIM _DstAddr AS WORD @$18
...
SUB DecompressZX0_Unsafe(SrcAddr AS WORD, DstAddr AS WORD) STATIC SHARED
    _SrcAddr = SrcAddr
    _DstAddr = DstAddr
    ASM
        jsr zx0_unpack
...
;
; ***************************************************************************
; Modified to support decompression to RAM in $e000-$ffff without disabling
; interrupts. This is done by Orlof, 2023-11-03.
; ***************************************************************************
...
zx0_srcptr      =       $16                     ; 1 word.
zx0_dstptr      =       $18                     ; 1 word.
zx0_length      =       $1a                     ; 1 word.
zx0_offset      =       $1c                     ; 1 word.
